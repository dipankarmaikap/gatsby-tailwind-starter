...
1. **Open the source code and start editing!**
   ...
   Open the `gatsby-tailwind-starter` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
